...
class Beneficiary(models.Model):
    ...
    other_name = models.CharField(_("Other Name"), max_length=200, null=True)
    gender = models.CharField(_("Gender"), max_length=100, choices=GENDER)
    profile_photo = models.ImageField(upload_to="profile_photo/")
    beneficiary_code = models.UUIDField(
        default=generate_uuid_and_agent_code()[0], editable=False
    )
    date_of_birth = models.DateField(_("Date of Birth"))
    marital_status = models.CharField(
        _("Marital Status"), choices=MARITAL_STATUS, max_length=100
    )
